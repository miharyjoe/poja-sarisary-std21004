...
public class ImageProcessingController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<String> convertToBlackAndWhite(@PathVariable String id,
  ...
  public ResponseEntity<Object> getTransformedImages(@PathVariable String id) {
    try {
      String originalUrl = bucketComponent.presign("original/" + id, Duration.ofMinutes(5)).toString();
      String transformedUrl = bucketComponent.presign("black-and-white/" + id, Duration.ofMinutes(5)).toString();
